        ...
        <footer className="border-t">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-lg font-semibold mb-4">E-Gourmet</h3>
                        <p className="text-sm text-muted-foreground">
                            Discover and review amazing food with personalized recommendations.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="/foods?category=vietnamese" className="text-sm text-muted-foreground hover:text-primary">
                                    Vietnamese
                                </a>
                            </li>
                            <li>
                                <a href="/foods?category=chinese" className="text-sm text-muted-foreground hover:text-primary">
                                    Chinese
                                </a>
                            </li>
                            <li>
                                <a href="/foods?category=japanese" className="text-sm text-muted-foreground hover:text-primary">
                                    Japanese
                                </a>
                            </li>
                        </ul>
                ...
                <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
                    <p>&copy; {new Date().getFullYear()} E-Gourmet. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
