...
func (s *EGServiceImpl) GetPosts(ctx context.Context, params *database.GetPostsParams) ([]*database.GetPostsRow, error) {
...
func (s *EGServiceImpl) CreatePost(ctx context.Context, params *database.CreatePostParams) (*database.Post, error) {
	return s.querier.CreatePost(ctx, s.dbtx, params)
}

func (s *EGServiceImpl) UpdatePost(ctx context.Context, params *database.UpdatePostParams) (*database.Post, error) {
...
func (s *EGServiceImpl) GetCommentsByPost(ctx context.Context, postId int64) ([]*database.GetCommentsByPostRow, error) {
	return s.querier.GetCommentsByPost(ctx, s.dbtx, postId)
}

func (s *EGServiceImpl) DeleteComment(ctx context.Context, params *database.DeleteCommentParams) error {
